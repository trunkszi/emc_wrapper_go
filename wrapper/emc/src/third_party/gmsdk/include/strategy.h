...
public: //交易函数
    ...
    //委托算法单
    AlgoOrder order_algo(const char *symbol, int volume, int position_effect, int side, int order_type, double price, const char *algo_name, const char *algo_param, const char *account = NULL);
