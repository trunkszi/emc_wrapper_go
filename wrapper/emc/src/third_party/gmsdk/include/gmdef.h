...
#define LEN_INFO  128
#define LEN_EXCHANGE  8
#define LEN_ISO_DATATIME  36
#define LEN_FREQUENCY  8
#define DEPTH_OF_QUOTE  10
#define LEN_PARAM  256
#define LEN_COMMENT  256
#define LEN_MAX_ORDER_QUEUE  50
#define LEN_TYPE  8
...
struct Tick
{
    ...
    struct Quote                  quotes[DEPTH_OF_QUOTE];   ///报价, 下标从0开始，0-表示第一档，1-表示第二档，依次类推
};
